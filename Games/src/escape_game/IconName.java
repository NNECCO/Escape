...
public class IconName {
	//westen-style-room
	public static final String DK_WEST_KEY = "洋室-DKの鍵";
	public static final String FLASHLIGHT = "懐中電灯";
	public static final String MAGNET = "可変式棒磁石";
	public static final String CUTTER = "カッター";
	//dk
